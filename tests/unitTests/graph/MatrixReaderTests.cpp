...
{
	// Arrange
	const std::string pathToFile = "./unitTests/graph/testData/InvalidMatrixWithNegativeMatrixSize.txt";
	std::ifstream file;
	file.open(pathToFile);
	ASSERT_TRUE(file);
	MatrixReader matrixReader;
...
TEST(MatrixReaderTests, ReadMatrixSize_WithSeparateMinusSignOnMatrixSizeLine_ThrowsException)
{
	// Arrange
	const std::string pathToFile = "./unitTests/graph/testData/InvalidMatrixWithSeparateMinusSignOnMatrixSizeLine.txt";
	std::ifstream file;
	file.open(pathToFile);
	ASSERT_TRUE(file);
	MatrixReader matrixReader;
...
TEST(MatrixReaderTests, ReadMatrixSize_WithMinusSignAfterMatrixSize_ThrowsException)
{
	// Arrange
	const std::string pathToFile = "./unitTests/graph/testData/InvalidMatrixWithMinusSignAfterMatrixSize.txt";
	std::ifstream file;
	file.open(pathToFile);
	ASSERT_TRUE(file);
	MatrixReader matrixReader;
...
TEST(MatrixReaderTests, ReadAdjacencyMatrix_WithNegativeNumbers_ReturnsValidMatrix)
{
	// Arrange
	const std::string pathToFile = "./unitTests/graph/testData/MatrixWithNegativeNumbers.txt";
	std::ifstream file;
	file.open(pathToFile);
	ASSERT_TRUE(file);
	MatrixReader matrixReader;
...
TEST(MatrixReaderTests, ReadAdjacencyMatrix_WithUnalignedColumns_ReturnsValidMatrix)
{
	// Arrange
	const std::string pathToFile = "./unitTests/graph/testData/MatrixWithUnalignedColumns.txt";
	std::ifstream file;
	file.open(pathToFile);
	ASSERT_TRUE(file);
	MatrixReader matrixReader;
...
TEST(MatrixReaderTests, ReadAdjacencyMatrix_WithSelfAdjacentVertexes_ReturnsValidMatrix)
{
	// Arrange
	const std::string pathToFile = "./unitTests/graph/testData/MatrixWithSelfAdjacentVertexes.txt";
	std::ifstream file;
	file.open(pathToFile);
	ASSERT_TRUE(file);
	MatrixReader matrixReader;
...
{
	// Arrange
	const std::string pathToFile = "./unitTests/graph/testData/MatrixWithOddColumns.txt";
	std::ifstream file;
	file.open(pathToFile);
	ASSERT_TRUE(file);
	MatrixReader matrixReader;
...
{
	// Arrange
	const std::string pathToFile = "./unitTests/graph/testData/MatrixWithOddRows.txt";
	std::ifstream file;
	file.open(pathToFile);
	ASSERT_TRUE(file);
	MatrixReader matrixReader;
...
TEST(MatrixReaderTests, ReadAdjacencyMatrix_WithSingleElement_ReturnsValidMatrix)
{
	// Arrange
	const std::string pathToFile = "./unitTests/graph/testData/MatrixWithSingleElement.txt";
	std::ifstream file;
	file.open(pathToFile);
	ASSERT_TRUE(file);
	MatrixReader matrixReader;
...
TEST(MatrixReaderTests, ReadAdjacencyMatrix_MatrixWithFourElements_ReturnsValidMatrix)
{
	// Arrange
	const std::string pathToFile = "./unitTests/graph/testData/MatrixWithFourElements.txt";
	std::ifstream file;
	file.open(pathToFile);
	ASSERT_TRUE(file);
	MatrixReader matrixReader;
...
{
	// Arrange
	const std::string pathToFile = "./unitTests/graph/testData/InvalidMatrixWithEmtpyLines.txt";
	std::ifstream file;
	file.open(pathToFile);
	ASSERT_TRUE(file);
	MatrixReader matrixReader;
...
TEST(MatrixReaderTests, ReadAdjacencyMatrix_WithMultipleShorterRows_ThrowsExceptio)
{
	// Arrange
	const std::string pathToFile = "./unitTests/graph/testData/InvalidMatrixWithMultipleShorterRows.txt";
	std::ifstream file;
	file.open(pathToFile);
	ASSERT_TRUE(file);
	MatrixReader matrixReader;
...
TEST(MatrixReaderTests, ReadAdjacencyMatrix_WithSingleShorterRow_ThrowsExceptio)
{
	// Arrange
	const std::string pathToFile = "./unitTests/graph/testData/InvalidMatrixWithSingleShorterRow.txt";
	std::ifstream file;
	file.open(pathToFile);
	ASSERT_TRUE(file);
	MatrixReader matrixReader;
...
TEST(MatrixReaderTests, ReadAdjacencyMatrix_WithInsufficientColumnAmount_ThrowsException)
{
	// Arrange
...
TEST(MatrixReaderTests, ReadAdjacencyMatrix_WithSeparateMinusSignOnMatrixRow_ThrowsException)
{
	// Arrange
	const std::string pathToFile = "./unitTests/graph/testData/InvalidMatrixWithSeparateMinusSignOnMatrixRow.txt";
	std::ifstream file;
	file.open(pathToFile);
	ASSERT_TRUE(file);
	MatrixReader matrixReader;
...
TEST(MatrixReaderTests, ReadAdjacencyMatrix_WithSingleMinusSignOnRow_ThrowsException)
{
	// Arrange
	const std::string pathToFile = "./unitTests/graph/testData/InvalidMatrixWithSingleMinusSignOnRow.txt";
	std::ifstream file;
	file.open(pathToFile);
	ASSERT_TRUE(file);
	MatrixReader matrixReader;

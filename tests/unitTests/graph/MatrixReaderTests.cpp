...
TEST(MatrixReaderTests, ReadAdjacencyMatrix_WithUnalignedColumns)
{
	// Arrange
...
TEST(MatrixReaderTests, ReadAdjacencyMatrix_WithSelfAdjacentVertexes)
{
	// Arrange
...
TEST(MatrixReaderTests, ReadAdjacencyMatrix_WithOddColumns)
{
	// Arrange
...
TEST(MatrixReaderTests, ReadAdjacencyMatrix_WithOddRows)
{
	// Arrange
...
TEST(MatrixReaderTests, ReadAdjacencyMatrix_WithSingleElement)
{
	// Arrange
...
TEST(MatrixReaderTests, ReadAdjacencyMatrix_MatrixWithFourElements)
{
	// Arrange
...
TEST(MatrixReaderTests, ReadAdjacencyMatrix_WithEmtpyLines)
{
	// Arrange
...
TEST(MatrixReaderTests, ReadAdjacencyMatrix_WithMultipleShorterRows)
{
	// Arrange
...
TEST(MatrixReaderTests, ReadAdjacencyMatrix_WithSingleShorterRow)
{
	// Arrange

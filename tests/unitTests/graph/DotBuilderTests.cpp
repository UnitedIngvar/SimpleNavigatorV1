...
TEST(DotBuilderTests, BuildDotFromGraph_WithSingleElementMatrix) {
	...
	auto graph = Graph(matrixReader,
	VertexMapBuilder,
	dotBuilder);
	graph.loadGraphFromFile("./unitTests/graph/testData/MatrixWithSingleElement.txt");
...
TEST(DotBuilderTests, BuildDotFromGraph_WithUndirectedUnweightedGraphMatrix) {
	...
	VertexMapBuilder,
	dotBuilder);
	graph.loadGraphFromFile("./unitTests/graph/testData/UndirectedUnweightedGraphMatrix.txt");
	std::string expectedDot = \
			"graph fancyGraph {\n"
			"\t1 -- 2;\n"
			"\t1 -- 4;\n"
...
TEST(DotBuilderTests, BuildDotFromGraph_WithUndirectedWeightedGraphMatrix) {
	...
	VertexMapBuilder,
	dotBuilder);
	graph.loadGraphFromFile("./unitTests/graph/testData/UndirectedWeightedGraphMatrix.txt");
	std::string expectedDot = \
			"graph fancyGraph {\n"
			"\t1 -- 2 [label = \"4\"];\n"
			"\t1 -- 4 [label = \"1\"];\n"
...
TEST(DotBuilderTests, BuildDotFromGraph_WithDirectedWeightedGraphMatrix) {
	...
	VertexMapBuilder,
	dotBuilder);
	graph.loadGraphFromFile("./unitTests/graph/testData/DirectedWeightedGraphMatrix.txt");
	std::string expectedDot = \
			"digraph fancyGraph {\n"
			"\t1 -> 4 [label = \"1\"];\n"
			"\n"
...
TEST(DotBuilderTests, BuildDotFromGraph_WithDirectedUnweightedGraphMatrix) {
	...
	VertexMapBuilder,
	dotBuilder);
	graph.loadGraphFromFile("./unitTests/graph/testData/DirectedUnweightedGraphMatrix.txt");
	std::string expectedDot = \
			"digraph fancyGraph {\n"
			"\t1 -> 4;\n"
			"\n"
